...
class TorchScaler(torch.nn.Module):
    ...
    def fit(self, dataloader, transform_func=lambda x: x[0]):
        ...
        self.register_buffer("mean", mean) # type: ignore
        self.register_buffer("mean_squared", mean_squared) # type: ignore
    ...
    def forward(self, tensor):
        ...
        if self.statistic == "dataset":
            ...
            if self.normtype == "mean":
                ...
                std = torch.sqrt(self.mean_squared - self.mean ** 2) # type: ignore
